...
class RecogniseHandWrittenDigits():
	...
	def createOptimizer(self, opt):
		...
		if opt=="adam":
			...
			designed_optimizer = optimizers.SGD(lr=0.1)
	...
	def trainModel(self, model):
		...
		self.trained_model.save("cnn_mnist_old.h5")
	...
	def loadModel(self):
		...
		self.trained_model = keras.models.load_model("cnn_mnist_old.h5")
...
if __name__ == '__main__':
	...
	fname = f'filter_layer{layer_name}_old.jpg'
